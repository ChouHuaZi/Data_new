...
# Read the chlorophyll a dataset
...
# Reading the dissolved oxygen dataset
...
# Loop through all TIFF files in a folder
input_folder = '原始影像'
output_folder = '溶解氧出图'
...
for filename in os.listdir(input_folder):
    if filename.endswith('.tif'):
        ...
        # Predicting chlorophyll a content using the chlorophyll a model
        ...
        # Generating input characteristics for dissolved oxygen
        ...
        # Write the prediction result TIFF file
